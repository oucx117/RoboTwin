...
class aloha_open_laptop(MultiThreadedDatasetBuilder):
    VERSION = tfds.core.Version("1.0.0")
    RELEASE_NOTES = {
        "1.0.0": "Initial release for RoboTwin open_laptop dataset.",
    }
    ...
    def _split_paths(self):
        train_files = glob.glob(
            "../../data/open_laptop/demo_clean/processed_openvla/train/*.hdf5"
        )
        val_files = glob.glob(
            "../../data/open_laptop/demo_clean/processed_openvla/val/*.hdf5"
        )
