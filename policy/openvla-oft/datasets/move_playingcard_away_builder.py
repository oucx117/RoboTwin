...
class aloha_move_playingcard_away(MultiThreadedDatasetBuilder):
    VERSION = tfds.core.Version("1.0.0")
    RELEASE_NOTES = {
        "1.0.0": "Initial release for RoboTwin move_playingcard_away dataset.",
    }
    ...
    def _split_paths(self):
        train_files = glob.glob(
            "../../data/move_playingcard_away/demo_clean/processed_openvla/train/*.hdf5"
        )
        val_files = glob.glob(
            "../../data/move_playingcard_away/demo_clean/processed_openvla/val/*.hdf5"
        )
...
if __name__ == "__main__":
    builder = aloha_move_playingcard_away()
